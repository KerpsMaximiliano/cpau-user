import { Component, OnInit, Input, ViewEncapsulation, Output, EventEmitter, OnChanges, SimpleChanges, AfterViewInit } from '@angular/core';
...
@Component({
  selector: 'app-template-agenda-tags',
  templateUrl: './template-agenda-tags.component.html',
  styleUrls: ['./template-agenda-tags.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class TemplateAgendaTagsComponent implements OnInit, TemplateWrapper, AfterViewInit {
